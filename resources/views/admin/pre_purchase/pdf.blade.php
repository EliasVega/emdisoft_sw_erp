...
<html>
    ...
    <header id="header">
        ...
        <!--DATOS company -->
            ...
            <!--DATOS FACTURA -->
            <div id="document">
                <p> <h4>PRECOMPRA <br> <strong id="documentNumber">N°.{{ $prePurchase->id }}</strong>  </h4>

                </p>
                <p> <h4>FECHA DE EMISION <br> <strong id="documentData">{{ date('d-m-Y', strtotime($prePurchase->created_at)) }}</strong>  </h4>
                </p>
            </div>
        </div>
    </header>
            ...
            <div class="center">
                ...
                <div id="third">
                    ...
                    <div id="thirdData">
                        ...
                        <span id="rowData">{{ $prePurchase->third->regime->name }}</span><br>
                    ...
                    <table class="table">
                        ...
                        <tbody class="detail">
                            ...
                            <tr>
                                ...
                                <td id="ccent">{{ number_format($prePurchaseProduct->quantity) }}</td>
                                <td class="tdder">${{ number_format($prePurchaseProduct->price)}}</td>
                                <td class="tdder">${{number_format($prePurchaseProduct->quantity * $prePurchaseProduct->price)}}</td>
                            </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
