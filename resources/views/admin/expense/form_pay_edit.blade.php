<div class="box-body row">
    <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12" id="formPay">
    ...
    <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12" id="payBalanceOld">
        <div class="form-group">
            ...
            <input type="text" name="balance_old" id="balance_old" value="{{ old('balance_old', $expense->balance ?? '') }}" class="form-control" placeholder="Saldo Gasto" readonly>
        </div>
    </div>
    <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12" id="payExpense">
        <div class="form-group">
            <label for="pay_expense">Pagos Gasto</label>
            <input type="text" name="pay_expense" id="pay_expense" value="{{ old('pay_expense', $expense->pay ?? '') }}" class="form-control" placeholder="Abonos Gasto" readonly>
        </div>
    </div>
