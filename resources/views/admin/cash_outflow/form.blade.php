<div class="box-body row">
    <div class="col-12 col-md-6">
        <div class="form-group">
            ...
            <input type="number" id="box" name="box" value="{{ $cashRegister->cash }}" class="form-control"
    ...
    <div class="col-12 col-md-12">
        <div class="form-group" id="save">
            ...
            <a href="{{url('cashOutflow')}}" class="btn btn-gris"><i class="fa fa-window-close"></i>&nbsp; Cancelar</a>
        </div>
    </div>
</div>
