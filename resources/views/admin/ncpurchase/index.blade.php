    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h5>Notas credito de compras
                @can('purchase.index')
                    <a href="{{ route('purchase.index') }}" class="btn btn-lightBlueGrad"><i class="fas fa-undo-alt mr-2"></i>Regresar</a>
                @endcan
                @can('branch.index')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-condensed table-hover" id="ncpurchases">
                    <thead>
                        <tr>
                            <th>Id</th>
                            <th>Sucursal</th>
