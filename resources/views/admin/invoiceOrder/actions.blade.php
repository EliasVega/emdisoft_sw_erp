@if ($status == 'active')
    <a href="{{ route('invoiceOrderInvoice', $id) }}" class="btn btn-lemonGrad btn-sm" data-toggle="tooltip" data-placement="top"
    title="Facturar Orden"><i class="fas fa-receipt"></i></a>
@else
    <a href="{{ route('invoiceOrderInvoice', $id) }}" class="btn btn-orangeGrad btn-sm" data-toggle="tooltip" data-placement="top"
    title="Facturar Orden"><i class="fas fa-receipt"></i></a>
@endif
...
<a href="{{ route('invoiceOrder.show', $id) }}" class="btn btn-success btn-sm" data-toggle="tooltip"
    data-placement="top" title="Ver Venta"><i class="far fa-eye"></i>
</a>
<a href="{{ route('invoiceOrderDelete', $id) }}" class="btn btn-danger btn-sm" data-toggle="tooltip"
    data-placement="top" title="ELiminar"><i class="far fa-edit"></i>
</a>
