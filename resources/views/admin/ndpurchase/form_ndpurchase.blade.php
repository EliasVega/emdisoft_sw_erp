            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="form-group">
                        ...
                        <span><strong>{{ $purchase->document }}</strong></span>
                    </div>
                </div>
                
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <div class="form-group">
                        <span><strong>Proveedor</strong></span><br>
                        <span><strong>{{ $purchase->third->name }}</strong></span>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="type_document">Tipo de impresion</label>
                            <select name="type_document" class="form-control selectpicker" id="type_document" data-live-search="true">
                                <option value="ndpurchase">Carta</option>
                    ...
                    <div class="form-group">
                        <button class="btn btn-blueGrad btn-sm mb-2 ml-3" type="button" id="addRetentions"
                            data-toggle="tooltip" data-placement="top" title="Retenciones"><i
                                class="fas fa-check"></i>Ver Retenciones</button>
                    </div>
                </div>
...
<div class="box-body row" id="doNotLook">
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="purchase">
        <div class="form-group">
            ...
            <input type="number" name="purchase_id" id="purchase_id" value="{{ $purchase->id }}"
    ...
    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12" id="idProvider">
        <div class="form-group">
            ...
            <input type="text" name="provider_id" id="provider_id" value="{{ $purchase->third->id }}"
                class="form-control" placeholder="" readonly>
        </div>
    </div>
