<div class="box-body row">
    ...
    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12" id="balancy">
        <div class="form-group">
            <label class="form-control-label" for="balance">Saldo Pendiente</label>
            <input type="number" id="balance" name="balance" value="{{ $sumDocuments }}" class="form-control blueGrad" disabled pattern="[0-9]{0,15}">
        </div>
    </div>
    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12" id="returny">
        <div class="form-group">
    ...
    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12" id="payi">
        <div class="form-group">
            <label class="form-control-label requerido" for="pay">Abono</label>
            <input type="text" id="pay" name="pay" value="{{ $sumDocuments }}"
                class="form-control blanco" placeholder="pay" pattern="[0-9]{0,15}">
        </div>
    </div>

    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12" id="abpaymenty">
        <div class="form-group">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="note" class="form-control" id="note" placeholder="Observaciones">
        </div>
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
