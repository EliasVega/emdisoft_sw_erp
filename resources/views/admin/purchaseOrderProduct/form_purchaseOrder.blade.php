            ...
            <div class="row">
                <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12" id="prepurch">
                    <div class="form-group">
                        ...
                        <input type="number" name="purchaseOrder" id="purchaseOrder" value="{{ $purchaseOrder->id }}"
                            class="form-control">
                    </div>
                </div>
                @if ($countBranchs > 1)
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="select">
                        <select id="provider_id" name="provider_id" class="form-control selectpicker" data-live-search="true">
                            <option {{ old('provider_id', $purchaseOrder->provider_id ?? '') == '' ? 'selected' : '' }} disabled>
                                Seleccionar Proveedor</option>
                ...
                @else
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12" id="documentBis">
                        <div class="form-group">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" id="invoiceCode">
                    <div class="form-group">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="addPayButton">
                    <div class="form-group">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="addRetentionButton">
                    <div class="form-group">
...
<div class="box-body row" id="invoicenegative">
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" id="addTypeProduct">
        <div class="form-group">
            ...
            <input type="text" id="typeProduct" name="typeProduct" class="form-control"
                value="product">
        </div>
    </div>
</div>
