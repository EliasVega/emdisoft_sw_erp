...
<div class="box-body row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" id="ndinvoiceretention">
        <div class="form-group">
            <label class="form-control-label" for="total_ndinvoice">Total factura</label>
            <input type="number" name="total_ndinvoice" id="total_ndinvoice" class="form-control" value="0" placeholder="total">
        </div>
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
