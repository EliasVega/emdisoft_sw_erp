    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="box-danger">
            <div class="box-header with-border">
                <h5 class="box-title">Editar Nomina de: {{ $payrollPartial->employee->name }}</h5>
                @can('payrollPartial.index')
            ...
            @endif
            {!!Form::model($branch, ['method'=>'PATCH','route'=>['payrollPartial.update', $payrollPartial->id]])!!}
            {!!Form::token()!!}
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
