@can('provider.edit')
    <a href="{{ route('provider.edit', $id) }}" class="btn btn-warning" data-toggle="tooltip"
    data-placement="top" title="Editar"><i class="far fa-edit"></i></a>
@endcan
@can('provider.show')
    <a href="{{ route('provider.show', $id) }}" class="btn btn-success btn-xs" data-toggle="tooltip"
...
@can('provider.providerStatus')
    @if ($status == 'active')
        <a href="{{ route('providerStatus', $id) }}" class="btn btn-verde" data-toggle="tooltip"
        data-placement="top" title="Desactivar"><i class="fas fa-icons"></i></a>
    @else
        <a href="{{ route('providerStatus', $id) }}" class="btn btn-danger" data-toggle="tooltip"
