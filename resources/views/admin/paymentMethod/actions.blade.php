@can('paymentMethod.edit')
    <a href="{{ route('paymentMethod.edit', $id) }}" class="btn btn-warning btn-sm" data-toggle="tooltip"
    data-placement="top" title="Editar"><i class="far fa-edit"></i></a>
@endcan
@can('paymentMethod.paymentMethodStatus')
    @if ($status == 'active')
        <a href="{{ route('paymentMethodStatus', $id) }}" class="btn btn-verde btn-sm" data-toggle="tooltip"
        data-placement="top" title="Desactivar"><i class="fas fa-icons"></i></a>
    @else
        <a href="{{ route('paymentMethodStatus', $id) }}" class="btn btn-danger btn-sm" data-toggle="tooltip"
