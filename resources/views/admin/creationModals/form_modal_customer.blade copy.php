<div class="box-body row">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" value="{{ old('name', $customer->name ?? '') }}" class="form-control" placeholder="Ingrese el nombre del Cliente" autocomplete="off" required>
        </div>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="form-group">
            <label for="email" class="required">Email</label>
            <input type="email" name="email" id="email" value="{{ old('email', $customer->email ?? '') }}" class="form-control required" placeholder="Correo electronico" autocomplete="off" required>
        </div>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="select">
            <select id="regime_id" name="regime_id" class="form-control selectpicker" data-live-search="true">
                <option {{ ($customer->regime_id ?? '') == '' ? "selected" : "" }} disabled>Seleccionar Regimen</option>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="address" id="address" value="{{ old('address', $customer->address ?? 'Bucaramanga') }}" class="form-control" placeholder="Direccion" autocomplete="off">
        </div>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
        <div class="form-group">
            <label for="phone">Telefono</label>
            <input type="text" name="phone" id="phone" value="{{ old('phone', $customer->phone ?? '3165555555') }}" class="form-control" placeholder="Telefono" autocomplete="off">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
        <div class="form-group">
            ...
            <input type="number" name="credit_limit" id="credit_limit" value="{{ old('credit_limit', $customer->credit_limit ?? '0') }}" class="form-control" placeholder="Cupo asignado">
        </div>
    </div>
