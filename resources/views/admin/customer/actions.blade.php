@can('customer.index')
    <a href="{{ route('customer.edit', $id) }}" class="btn btn-warning"
    data-toggle="tooltip" data-placement="top" title="Editar"><i class="far fa-edit"></i></a>
@endcan
@can('customer.show')
    <a href="{{ route('customer.show', $id) }}" class="btn btn-success btn-xs" data-toggle="tooltip"
...
@can('customer.customerStatus')
    @if ($status == 'active')
        <a href="{{ route('customerStatus', $id) }}" class="btn btn-verde" data-toggle="tooltip"
        data-placement="top" title="Desactivar"><i class="fas fa-icons"></i></a>
    @else
        <a href="{{ route('customerStatus', $id) }}" class="btn btn-danger" data-toggle="tooltip"
