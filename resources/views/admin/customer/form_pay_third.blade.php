<div class="box-body row">
    ...
    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12" id="total_p">
        <div class="form-group">
            ...
            <input type="number" id="total_document" name="total_document" value="{{ $sumInvoices }}" class="form-control blueGrad" disabled pattern="[0-9]{0,15}">
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12" id="balancy">
        <div class="form-group">
            ...
            <input type="number" id="balance" name="balance" value="{{ $sumInvoices }}" class="form-control blueGrad" disabled pattern="[0-9]{0,15}">
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12" id="payi">
        <div class="form-group">
            ...
            <input type="number" id="pay" name="pay" value="{{ $sumInvoices }}"
