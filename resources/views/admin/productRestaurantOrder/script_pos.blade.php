        ...
        restaurantOrder.forEach((value, i) => {
            if (value['quantity'] > 0) {
                ...
                if(product_id !="" && quantity!="" && quantity>0  && price!="" && price>0){
                    ...
                    var row= '<tr class="selected" id="row'+cont+'"><td><input type="hidden" name="product_id[]" value="'+product_id+'">'+product+'</td>   <td><input type="hidden" name="quantity[]" value="'+quantity+'">'+quantity+'</td> <td><input type="hidden" name="price[]"  value="'+price+'">'+parseFloat(price).toFixed(3)+'</td><td><input type="hidden" name="ivaline[]"  value="'+ivita+'">'+parseFloat(ivita).toFixed(3)+'</td> <td><input type="hidden" name="tax_rate[]"  value="'+tax_rate+'">'+tax_rate+'</td><td>$'+parseFloat(subtotal[cont]).toFixed(3)+' </td></tr>';
                    cont++;
