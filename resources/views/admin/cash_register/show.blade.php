    ...
    <main class="main">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 offset-lg-4">
                <a href="{{ route('cashRegister.index') }}" class="btn btn-lightBlueGrad"><i
                        class="fa fa-plus mr-2"></i>Regresar</a>
                        ...
                        <table class="table table-striped table-bordered table-condensed table-hover">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>
                                        <p align="right">${{ number_format($cashRegister->invoice, 2) }}</p>
                                    </th>
                                </tr>
                            </tfoot>
                            <tbody>
                        ...
                        <table class="table table-striped table-bordered table-condensed table-hover">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>
                                        <p align="right">${{ number_format($cashRegister->remission, 2) }}</p>
                                    </th>
                                </tr>
                            </tfoot>
                            <tbody>
                        ...
                        <table class="table table-striped table-bordered table-condensed table-hover">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>
                                        <p align="right">${{ number_format($cashRegister->purchase, 2) }}</p>
                                    </th>
                                </tr>
                            </tfoot>
                            <tbody>
                        ...
                        <table class="table table-striped table-bordered table-condensed table-hover">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>
                                        <p align="right">${{ number_format($cashRegister->expense, 2) }}</p>
                                    </th>
                                </tr>
                            </tfoot>
                            <tbody>
                        ...
                        <table class="table table-striped table-bordered table-condensed table-hover">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>
                                        <p align="right">${{ number_format($ndinvoiceTotal, 2) }}</p>
                                    </th>
                                </tr>
                            </tfoot>
                            <tbody>
                        ...
                        <table class="table table-striped table-bordered table-condensed table-hover">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>
                                        <p align="right">${{ number_format($ncinvoiceTotal, 2) }}</p>
                                    </th>
                                </tr>
                            </tfoot>
                            <tbody>
                        ...
                        <table class="table table-striped table-bordered table-condensed table-hover">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>
                                        <p align="right">${{ number_format($ndpurchaseTotal, 2) }}</p>
                                    </th>
                                </tr>
                            </tfoot>
                            <tbody>
                        ...
                        <table class="table table-striped table-bordered table-condensed table-hover">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>
                                        <p align="right">${{ number_format($cashRegister->purchase_order, 2) }}</p>
                                    </th>
                                </tr>
                            </tfoot>
                            <tbody>
                                @foreach ($purchaseOrders as $purchaseOrder)
                                    <tr>
                                        ...
                                        <td>{{ $purchaseOrder->document }}</td>
                                        <td>{{ $purchaseOrder->third->name }}</td>
                                        <td>{{ $purchaseOrder->status }}</td>
                                        <td class="rightfoot">$ {{ number_format($purchaseOrder->total_pay, 2) }}</td>
                        ...
                        <table class="table table-striped table-bordered table-condensed table-hover">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>
                                        <p align="right">${{ number_format($cashRegister->invoice_order, 2) }}</p>
                                    </th>
                                </tr>
                            </tfoot>
                            <tbody>
                                @foreach ($invoiceOrders as $invoiceOrder)
                                    <tr>
                                        ...
                                        <td>{{ $invoiceOrder->document }}</td>
                                        <td>{{ $invoiceOrder->third->name }}</td>
                                        <td>invoiceO{ $order->status }}</td>
                                        <td class="rightfoot">$ {{ number_format($invoiceOrder->total_pay, 2) }}</td>
                        ...
                        <table class="table table-striped table-bordered table-condensed table-hover">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>
                                        <p align="right">${{ number_format($cashRegister->restaurant_order, 2) }}</p>
                                    </th>
                                </tr>
                            </tfoot>
                            <tbody>
                                @foreach ($restaurantOrders as $restaurantOrder)
                                    <tr>
                                        <td>{{ $restaurantOrder->created_at }}</td>
                                        <td>{{ $restaurantOrder->document }}</td>
                                        <td>{{ $restaurantOrder->third->name }}</td>
                                        <td>{{ $restaurantOrder->status }}</td>
                                        <td class="rightfoot">$ {{ number_format($restaurantOrder->total_pay, 2) }}
                                        </td>
                        ...
                        <table class="table table-striped table-bordered table-condensed table-hover">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>
                                        <p align="right">${{ number_format($sumCashOutflow, 2) }}</p>
                                    </th>
                                </tr>
                            </tfoot>
                            <tbody>
                        ...
                        <table class="table table-striped table-bordered table-condensed table-hover">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>
                                        <p align="right">${{ number_format($sumCashInflow, 2) }}</p>
                                    </th>
                                </tr>
                            </tfoot>
                            <tbody>
