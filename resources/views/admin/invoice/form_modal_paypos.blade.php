<div class="box-body row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="methodPayModal">
        <div class="form-group">
...
<div class="box-body row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="pendaddModal">
        <div class="form-group">
            <label class="form-control-label" for="pendientModal">Pendiente</label>
            <input type="number" id="pendientModal" value="0" class="form-control" disabled pattern="[0-9]{0,15}">
        </div>
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="valuePayModal">
        <div class="form-group">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="returnedBalanceModal">
        <div class="form-group">
