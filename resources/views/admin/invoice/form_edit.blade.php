<div class="box-body row">
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
        ...
        <div class="select">
            <select id="customer_id" name="customer_id" class="form-control selectpicker" data-live-search="true" required>
                <option {{ old('customer_id', $customer->customer_id ?? '') == '' ? "selected" : "" }} disabled>Seleccionar Cliente</option>
                @foreach($customers as $customer)
                    @if(old('customer_id', $customer->customer_id ?? '') == $customer->id)
    ...
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
        ...
        <div class="select">
            <select id="branch_id" name="branch_id" class="form-control selectpicker" data-live-search="true" disabled>
                <option {{ old('branch_id', $Invoice->branch_id ?? '') == '' ? "selected" : "" }} disabled>Seleccionar tipo de persona</option>
                @foreach($branchs as $branch)
                    @if(old('branch_id', $Invoice->branch_id ?? '') == $branch->id)
    ...
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" id="editDocument">
        <div class="form-group">
            ...
            <input type="text" id="document" name="document" value="{{ $Invoice->document }}" class="form-control" placeholder="Numero de la factura" required readonly>
        </div>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
        <div class="form-group">
            <label class="form-control-label" for="generation_date">Fecha Generacion</label>
            <input type="date" name="generation_date" value="{{ $Invoice->generation_date }}" class="form-control" placeholder="Fecha Vencimiento">
        </div>
    </div>
