...
<main class="main">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h5>Respuesta Nota credito
                @can('ncinvoiceResponse.create')
                    <a href="ncinvoiceResponse/create" class="btn btn-greenGrad btn-sm"><i class="fa fa-plus"></i>Agregar Respuesta NC</a>
                @endcan
                @can('company.index')
...
$(document).ready(function ()
    {
        $('#response').DataTable(
        {
            ...
            ajax: '{{ route('ncinvoiceResponse.index') }}',
            order: [[0, "desc"]],
            columns:
            [
                {data: 'id'},
