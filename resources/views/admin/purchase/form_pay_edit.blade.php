<div class="box-body row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="payPurchase">
        <div class="form-group">
            <label for="pay_purchase">Pagos Factura</label>
            <input type="text" name="pay_purchase" id="pay_purchase" value="{{ old('pay_purchase', $payPurchases ?? '') }}" class="form-control" placeholder="Codigo del product" readonly>
        </div>
    </div>
