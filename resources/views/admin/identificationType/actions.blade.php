@can('identificationType.edit')
    <a href="{{ route('identificationType.edit', $id) }}" class="btn btn-warning btn-sm"
    data-toggle="tooltip" data-placement="top" title="Editar"><i class="far fa-edit"></i></a>
@endcan
@can('identificationType.destroy')
...
@endcan
@include('admin.identificationType.delete', ['id' => $id])
