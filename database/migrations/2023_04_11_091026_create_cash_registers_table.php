...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('cash_registers', function (Blueprint $table) {
            ...
            $table->decimal('in_remission_cash',20,2)->default(0);//ingreso efectivo por Remision
            $table->decimal('in_remission',20,2)->default(0);//ingreso total por remisiones
            $table->decimal('remission',20,2)->default(0);//total de remisiones
