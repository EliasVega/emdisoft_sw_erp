...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('product_rawmaterials', function (Blueprint $table) {
            ...
            $table->decimal('quantity', 20,4);//cantidad de producto que consume el producto
            $table->decimal('consumer_price', 20,4);//precio del producto
            $table->decimal('subtotal', 20,4);//cantidad por el precio
