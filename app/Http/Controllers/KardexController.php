...
class KardexController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            ->addColumn('type', function (Kardex $kardex) {
                return $kardex->kardexable->type_product;
            })
    ...
    public function kardexProduct(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            if ($startDate && $endDate) {
                ...
                $kardexes = Kardex::where('kardexable_id', $id)->whereBetween('created_at', [$startDateTime, $endDateTime])->get();
            } else {
                $kardexes = Kardex::where('kardexable_id', $id)->get();
            }
            return DataTables::of($kardexes)
